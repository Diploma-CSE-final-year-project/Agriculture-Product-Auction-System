<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loginFarmer.aspx.cs" Inherits="AgricultureAuction.loginFarmer" %>
...
<body>
	...
	<div class="services" id="services">
		<div class="container">
            ...
            <div class="container">
                <h3 class="title clr">Login Farmer</h3>
                <div class="contact-two-grids">
                    <div class="col-md-12 contact-left-grid">
                        ...
                        <div class="col-md-12 col-sm-12 contact-us">
                            <form id ="form1" runat="server">
                                ...
                                <div class="styled-input">
                                    ...
                                    <asp:TextBox ID ="farmerid" runat="server" Tex="Farmer ID"></asp:TextBox> 
                                ...
                                <div class="styled-input">
                                    ...
                                    <asp:TextBox ID ="farmerpass" runat="server"></asp:TextBox>
                                ...
                                <div>
                                    <div class="click">
                                        <asp:Button  ID ="btnLoginFarmer" Text ="Submit" runat="server" OnClick="btnLoginFarmer_Click" />
                        ...
                        <h4>
                        <a href ="farmerForgetPass.aspx">Forgot Password!!! Recover</a>
                        </h4>
                        
                        <h4>
                        <a href ="registerFarmer.aspx">If Your Are New!!!! Register Here</a>
                        </h4>
