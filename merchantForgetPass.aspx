<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="merchantForgetPass.aspx.cs" Inherits="AgricultureAuction.merchantForgetPass" %>
...
<body>
	...
	<div class="services" id="services">
		<div class="container">
            ...
            <div class="container">
                <h3 class="title clr">Forget Password</h3>
                        ...
                        <div class="col-md-12 col-sm-12 contact-us">
                            <form id ="form1" runat="server">
                                ...
                                <div class="styled-input">
                                    ...
                                    <asp:TextBox ID ="phone" runat="server" Text="Enter Phone"></asp:TextBox> 
                                ...
                                <div class="styled-input">
                                    ...
                                    <asp:TextBox ID ="name" runat="server" Text ="Enter Name"></asp:TextBox>
                                ...
                                <div>
                                    <div class="click">
                                        <asp:Button  ID ="btnGetMerchantPass" Text ="Submit" runat="server" OnClick="btnGetMerchantPass_Click"  />
