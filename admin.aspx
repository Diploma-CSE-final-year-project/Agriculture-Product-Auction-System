<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="AgricultureAuction.admin" %>
...
<body>
	...
	<div class="services" id="services">
		<div class="container">
            ...
            <div class="container">
                <h3 class="title clr">Login Admin</h3>
                    ...
                    <div class="col-md-12 contact-left-grid">
                        ...
                        <div class="col-md-12 col-sm-12 contact-us">
                            <form id ="form1" runat="server">
                                ...
                                <div>
                                    <div class="click">
                                        <asp:Button  ID ="btnLoginAdmin" Text ="Submit" runat="server" OnClick="btnLoginAdmin_Click" />
