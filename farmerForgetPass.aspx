<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="farmerForgetPass.aspx.cs" Inherits="AgricultureAuction.farmerForgetPass" %>
                        ...
                        <div class="col-md-12 col-sm-12 contact-us">
                            <form id ="form1" runat="server">
                                ...
                                <div class="styled-input">
                                    ...
                                    <asp:TextBox ID ="farmername" runat="server" Text ="Enter Name"></asp:TextBox>
                                ...
                                <div>
                                    <div class="click">
                                        <asp:Button  ID ="btnGetFarmerPass" Text ="Submit" runat="server" OnClick="btnGetFarmerPass_Click"  />
