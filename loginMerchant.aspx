<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loginMerchant.aspx.cs" Inherits="AgricultureAuction.loginMerchant" %>
...
<body>
	...
	<div class="services" id="services">
		<div class="container">
            ...
            <div class="container">
                <h3 class="title clr">Login Merchant</h3>
                <div class="contact-two-grids">
                    <div class="col-md-12 contact-left-grid">
                        ...
                        <div class="col-md-12 col-sm-12 contact-us">
                            <form id ="form1" runat="server">
                                ...
                                <div class="styled-input">
                                    ...
                                    <asp:TextBox ID ="merchantpass" runat="server"></asp:TextBox>
                                ...
                                <div>
                                    <div class="click">
                                        <asp:Button  ID ="btnLoginMerchant" Text ="Submit" runat="server" OnClick="btnLoginMerchant_Click"  />
                        ...
                        <h4>
                        <a href ="merchantForgetPass.aspx">Forgot Password!!! Recover</a>
                        </h4>
                        
                        <h4>
                        <a href ="registerMerchant.aspx">If Your Are New!!!! Register Here</a>
                            </h4>
                        <div class="clearfix"> </div>
                    </div>
