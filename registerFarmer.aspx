<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registerFarmer.aspx.cs" Inherits="AgricultureAuction.registerFarmer" %>
...
<body>
	...
	<div class="services" id="services">
		<div class="container">
            ...
            <div class="container">
                <h3 class="title clr">Register Farmer</h3>
                        ...
                        <div class="col-md-12 col-sm-12 contact-us">
                            <form id ="form1" runat="server">
                                ...
                                <div class="styled-input">
                                    ...
                                    <asp:TextBox ID ="place" runat="server" Text="Place"></asp:TextBox>
                                ...
                                <div class="styled-input">
                                    ...
                                    <asp:TextBox ID ="city" runat="server" Text="City"></asp:TextBox>
