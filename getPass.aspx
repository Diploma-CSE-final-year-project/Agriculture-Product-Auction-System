<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="getPass.aspx.cs" Inherits="AgricultureAuction.getPass" %>
...
<body>
	<div class="header-outs">
		...
		<div class="container">
            ...
            <div class="container">
                <h3 class="title clr">Your Password 
                ...
                <form id="form1" runat ="server">
                  ...
                  <h3 class="title clr">  <asp:Label ID ="lblPassword" runat ="server"></asp:Label>
                      </h3>
                    </form>
	...
	<footer>
		<div class="container">
			<div class="col-md-7 col-sm-8 header-side">
				<p>© 2020 Online Auction. target="_blank">W3Layouts</a></p>
			</div>
