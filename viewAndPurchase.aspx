<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewAndPurchase.aspx.cs" Inherits="AgricultureAuction.viewAndPurchase" %>
...
<body>
	...
	<div class="services" id="services">
		<div class="container">
            ...
            <div class="container">
                <h3 class="title clr">Purchase</h3>
                        ...
                        <div class="col-md-12 col-sm-12 contact-us">
                            <form id ="form1" runat="server">
                                ...
                                <div class="styled-input">
                                    ...
                                    <asp:TextBox ID ="merchantname" runat="server" Text="Merchant Name"></asp:TextBox>
                                ...
                                <asp:TextBox ID ="amount" runat="server" Text ="Enter Amount"></asp:TextBox>
                                ...
                                <div>
                                    <div class="click">
                                        <asp:Button id ="btn_Purchase" runat="server" Text="Purchase" OnClick="btn_Purchase_Click1" />
